...
public class BanqueServiceLocator extends org.apache.axis.client.Service implements banquews.BanqueService {
    ...
    public banquews.Banque getBanque(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	banquews.BanqueSoapBindingStub _stub = new banquews.BanqueSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (banquews.Banque.class.isAssignableFrom(serviceEndpointInterface)) {
            	banquews.BanqueSoapBindingStub _stub = new banquews.BanqueSoapBindingStub(new java.net.URL(Banque_address), this);
                _stub.setPortName(getBanqueWSDDServiceName());
                return _stub;
            }
        }
